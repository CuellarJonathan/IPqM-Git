...
export default function NewSaassPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Novo saass</h1>
          <p className="text-gray-600">Preencha os dados para criar um novo saass</p>
        </div>
      </div>
